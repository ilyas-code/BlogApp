...
import { HeartIcon, TrashIcon, CalendarIcon, UserIcon, ShareIcon } from "@heroicons/react/20/solid";
          ...
          <div className="p-8 border-b border-gray-100">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                >
                  <ShareIcon className="h-6 w-6 text-gray-400 group-hover:text-blue-500" />
                  {copied && (
                ...
                {isOwner && (
                  ...
                  >
                    <i className="bi bi-trash-fill h-6 w-6 text-gray-400 hover:text-red-500"></i>
